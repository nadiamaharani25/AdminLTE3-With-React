...
import Image from "./assets/nadia.png"
                ...
                <aside className="main-sidebar sidebar-dark-primary elevation-4">
                    ...
                    <div className="sidebar">
                        <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                            <div className="image">
                                <img src={Image} className="brand-image img-circle elevation-3" alt="User Image" />
                            </div>
                            <div className="info">
                                <a href="#" className="d-block">Nadia Maharani</a>
                            </div>
                        </div>
                            ...
                            <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                <li className="nav-item menu-open">
                                    ...
                                    <ul className="nav nav-treeview">
                                        ...
                                        <li className="nav-item">
                                            <a href="/genre.html" className="nav-link">
                                                <i className="far fa-circle nav-icon" />
                                                <p>Genre</p>
                                            </a>
                                        </li>
                                        <li className="nav-item">
                                            <a href="/movie.html" className="nav-link">
                                                <i className="far fa-circle nav-icon" />
                                                <p>Movie</p>
                                            </a>
                                        </li>
